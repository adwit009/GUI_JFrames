...
public class CalculatorUsingGUI extends JFrame implements ActionListener {
...
jb_1.addActionListener(this);
 ...
 CalculatorUsingGUI hi = new CalculatorUsingGUI();
 ...
 hi.setVisible(true);
	...
	default:
		JOptionPane.showMessageDialog(null, "Error, please enter jb_3 value, an operator, another value\nand then click the equals sign");
		break;
	}
